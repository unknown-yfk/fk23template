        ...
        <div className="p-5">
          <div className="p-5">
            ...
            >
              ...
              <div className={`${state.direction === 'rtl' ? 'text-left' : 'text-right'}`}>
                <small>Amount</small>
              </div>
            </Row>
            <Divider className="m-0" />
            {MockInvoice.map((item, index) => (
              <div key={index}>
                <Row
                  ...
                  className="py-4"
                >
                  <div className={`${state.direction === 'rtl' ? 'ml-auto' : 'mr-auto'}`}>
            ...
            <Row>
              <div
                className={`${state.direction === 'rtl' ? 'mr-auto' : 'ml-auto'}`}
                css={`
                  display: block;
                  width: 100%;
                  max-width: 400px;
              ...
              >
                <Row
                  ...
                  className="py-4"
                >
                  <small className={`${state.direction === 'rtl' ? 'ml-auto' : 'mr-auto'} text-muted`}>Subtotal</small>
                  <span className={`${state.direction === 'rtl' ? 'text-left' : 'text-right'}`}>
                ...
                <Row
                  ...
                  className="py-4"
                >
                  <small className={`${state.direction === 'rtl' ? 'ml-auto' : 'mr-auto'} text-muted`}>Tax</small>
                  <span>
                ...
                <Row
                  ...
                  className="py-4"
                >
                  <small className={`${state.direction === 'rtl' ? 'ml-auto' : 'mr-auto'} text-muted`}>Discount</small>
                  <span>
                ...
                <Row
                  ...
                  className="py-4"
                >
                  <small className={`${state.direction === 'rtl' ? 'ml-auto' : 'mr-auto'} text-muted`}>Total</small>
