...
const DescriptionItem = ({ title, content }) => (
  <div className="text-muted mb-2">
    ...
    <small className="mx-3">{content}</small>
  </div>
);
      ...
      <Card
        ...
        title={
          <Row type="flex" align="middle">
            <Avatar size={64} src="/images/avatar.jpg" />
            {!state.mobile && (
              <div
      ...
      <Row type="flex" gutter={16}>
        ...
        >
          <Card bodyStyle={{ padding: 0 }} className="mb-4">
              ...
              <Row type="flex" align="top" justify="space-between">
                ...
                <Col>
                  <div className="text-center">
                    <Avatar size={80} src="/images/avatar.jpg" />
                  </div>
            ...
            <Divider orientation={`${state.direction === 'rtl' ? 'right': 'left'}`}>
              <small>Stats</small>
            </Divider>
        ...
        >
          ...
          {activeTab === '4' && (
            <Card>
              <Form>
                <FormItem {...formItemLayout} label="First name" name="fname" rules={[
                      {
                        required: true,
                ...
                <FormItem {...formItemLayout} label="Last name" name="lname" rules={[
                      {
                        required: true,
                ...
                <FormItem {...formItemLayout} label="E-mail" name="email" rules={[
                      {
                        type: 'email',
                ...
                <FormItem {...formItemLayout} label="Phone Number" name="phone" rules={[
                      {
                        required: true,
                ...
                <FormItem {...formItemLayout} label="Company name" name="company" rules={[
                      {
                        required: true,
                ...
                <FormItem {...formItemLayout} label="Website" name="website" rules={[
                ...
                <FormItem {...formItemLayout} label="Address line" name="addline" rules={[
                      {
                        required: true,
                ...
                <FormItem {...formItemLayout} label="Address line cont" name="addlinecont">
                  <Input />
                </FormItem>

                <FormItem {...formItemLayout} label="City" name="city" rules={[
                      {
                        required: true,
                ...
                <FormItem {...formItemLayout} label="State/Province" name="state" rules={[
                      {
                        required: true,
                ...
                <FormItem {...formItemLayout} label="Postal code" name="postal" rules={[
                      {
                        required: true,
                ...
                <FormItem {...formItemLayout} label="Country" name="country" rules={[
                      {
                        required: true,
